...
export default function HeroSection() {
  return (
    <section className="relative min-h-[100svh] flex items-center bg-white overflow-hidden">
      ...
      <div
        className="absolute inset-0 bg-gradient-to-br from-brand-red/5 via-transparent to-gold/3 pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 md:py-28">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-start order-2 md:order-1">
            ...
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-dark leading-tight mb-6">
              نقل بضائعك في الكويت{" "}
              <span className="text-brand-red">بكل ثقة واحتراف</span>
            </h1>

            <p className="text-dark/60 text-lg md:text-xl mb-8 leading-relaxed max-w-xl mx-auto md:mx-0">
            ...
            {/* ثقة */}
            <div className="mt-10 flex items-center gap-6 justify-center md:justify-start text-dark/40 text-sm">
              ...
              <span className="w-px h-4 bg-dark/20" aria-hidden="true" />
              <span>22+ منطقة</span>
              <span className="w-px h-4 bg-dark/20" aria-hidden="true" />
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="relative w-full max-w-sm md:max-w-none">
              <div
                className="absolute inset-0 rounded-3xl bg-brand-red/10 blur-3xl scale-95"
                aria-hidden="true"
              />
              <div className="relative rounded-3xl overflow-hidden border border-gray-100 bg-light aspect-[4/3] md:aspect-[3/2] shadow-lg">
                <Image
      ...
      <div className="absolute bottom-8 inset-x-0 flex justify-center" aria-hidden="true">
        <div className="w-8 h-8 border-2 border-dark/20 rounded-full flex items-center justify-center animate-bounce text-dark/30">
